...
**Parts needed:**  
-  [PCB r4](https://github.com/CuriousTech/GoldenChute)  Moved the DI trace to fix RF issues with a new module, and removed ground flood around it as well.  
...
-  V2016B heatsink (optional, but recommended)  
